...
**Next concrete target:** **Exercise 6.21** (extend 6.19/6.20 to functors also generated by the
*separated* sum `D₀ ⊕ D₁` and the other operations on p. 113), or other open Lecture VI/VII items.
